...
> published and installable now. The first-party `@chatpack/client` package
> provides the matching typed REST, SSE, and React client. The API is young - expect minor breaking
