...
> the new code.
>
> Threads add `thread_root_message_id` and `show_in_main` to `chatpack_messages`,
> plus an index for reply pages. Re-run the exported migration before enabling
> threads or allowing a reply to appear in the main conversation.
>
