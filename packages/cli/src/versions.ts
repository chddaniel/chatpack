 ...
 * adapter is not merely untested, it fails. Every version below must always
 * name one published, mutually compatible release set.
 *
...
export const chatpackVersions = {
  CHATPACK_CORE_VERSION: "0.14.0",
  CHATPACK_CLIENT_VERSION: "0.9.0",
  CHATPACK_ADAPTER_DRIZZLE_VERSION: "0.10.0",
  CHATPACK_FILE_VERSION: "0.1.8",
  CHATPACK_TRANSPORT_REDIS_VERSION: "0.2.1",
} as const;
...
export const versionTokenSources: Record<keyof typeof chatpackVersions, string> = {
  ...
  CHATPACK_FILE_VERSION: "file",
  CHATPACK_TRANSPORT_REDIS_VERSION: "transport-redis",
};
