...
| 400    | `MENTION_NOT_PARTICIPANT`                                                                                                                     | a [mention](/docs/concepts/conversations-messages#mentions-ids-you-supply-not-text-we-parse) named someone outside the conversation - nothing is stored |
