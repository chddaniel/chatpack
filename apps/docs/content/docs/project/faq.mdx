...
What isn't there: per-group permission grants, mentions, and
public/discoverable channels. Chatpack owns membership, roles, and the two ways
in; the social layer around them stays your app's.
