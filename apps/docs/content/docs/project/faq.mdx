...
All deliberately out of scope - see [Roadmap](/docs/project/roadmap).
Attachments can point at files you host via `metadata`. Reactions,
quote-replies, and group chats **did** ship - each fit the existing seams.

</Accordion>

<Accordion title="Do group chats work? What about invite links and mentions?">
...
What isn't there: invite links, join requests, per-group permission grants,
mentions, and public/discoverable channels. Chatpack owns membership and roles;
the social layer around them stays your app's.
