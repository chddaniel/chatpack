...
Group, channel, invite, join-request, and moderation blocks call their typed
client actions. They do not accept fake report, mute, member, or channel arrays.
Host callbacks remain for profile rendering, navigation, and success handling.
